...
## Installation
Simply download and copy the repository into your local disk (whereever you like - e.g. *C:\\ch-apps\\player\\* )
Run the player by opening the index.html page in your preffered web browser (double-clicking it should open it in default browser on most systems)
## Screenshot
